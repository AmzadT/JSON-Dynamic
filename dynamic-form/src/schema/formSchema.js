export const formSchema = [
  {
    ...
    fields: [
      ...
      { label: "Country", name: "country", type: "select", options: ["India", "USA", "Germany", "Canada", "France", "Australia", "UK", "Japan", "China"], required: true },
      { label: "Subscribe to Newsletter", name: "newsletter", type: "checkbox" },
      {
        label: "Work Experience", name: "workExperience", type: "repeatable",
        fields: [
  ...
  },
  {
    ...
    fields: [
      {
        label: "Education History", name: "education", type: "repeatable",
        fields: [
